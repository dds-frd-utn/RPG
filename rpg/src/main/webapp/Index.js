...
$("#botonLogin").click( function(){
  var urlApi = "http://localhost:8080/rpg/rest/cuentas/".concat($("#inputIdCuenta").val())
  var urlCuenta = "http://localhost:8080/rpg/rest/cuentas/".concat($("#inputIdCuenta").val())
  $.ajax({
    url: urlApi,
...
function mostrarMensajeBienvenida(data){
  ...
  var urlApi = "http://localhost:8080/rpg/rest/clientes/".concat(infoCuenta.idCliente.toString())
...
function gestionRetiro(event){
  ...
  $("#botonRetiro").on('click', event.data, function(event){
    ...
    $.ajax({
      url: `http://localhost:8080/rpg/rest/cuentas/${nroCuenta}`,
      type: 'GET',
      ...
      success: function(data){
        ...
        if(montoARetirar>0 && montoARetirar<=infoCuenta.saldo){
          ...
          urlApi = `http://localhost:8080/rpg/rest/cuentas/${infoCuenta.idCuenta}`
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              $.ajax({
                url: "http://localhost:8080/rpg/rest/movimientos",
                type: 'POST',
                contentType: "application/json",
                data: `{
...
function realizarTransferencia(event){
  ...
  if((montoTransferencia*impuesto <= infoCuentaOrigen.saldo) && (montoTransferencia > 0)){
    var urlApi = `http://localhost:8080/rpg/rest/cuentas/${cuentaDestino}`
        ...
        if(typeof(data) == "undefined"){
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              urlApi = `http://localhost:8080/rpg/rest/cuentas/${infoCuentaOrigen.idCuenta}`
